document.addEventListener("DOMContentLoaded", () => {
    ...
    btn_search.addEventListener("click", () => {
      ...
      self.location.href =
        "./admin_product.php?sn=" + sn.value + "&sf=" + sf.value;
    });
  
    // 전체목록 보여주기
    const btn_all = document.querySelector("#btn_all");
    btn_all.addEventListener("click", () => {
      self.location.href = "./admin_product.php";
    });
    ...
    btn_mem_edit_arr.forEach((value) => {
      value.addEventListener("click", () => {
        ...
        self.location.href = "../product/product_board_view.php?num=" + idx;
      });
    });
    ...
    btn_mem_delete_arr.forEach((value) => {
      value.addEventListener("click", () => {
        ...
        xhr.open("POST", "./pg/product_delete.php", true);
        // 전송데이터
