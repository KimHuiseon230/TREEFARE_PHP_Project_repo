...
<?php
// 공통적으로 처리하는 부분
// $js_array = ['/image_board/js/board.js', '/image_board/js/board_form.php'];
$title = "상품";
$menu_code = "product";
?>
        ...
        <div class="products">
          ...
          ?>
            ...
            <div class="product-list">
              <a href="board_view.php?num=<?= $num ?>&page=<?= $page ?>" class="product">
                <?php if (strpos($file_type_0, "image") !== false) echo "<img  class='hover:grow hover:shadow-lg' src='./data/$file_name_0' 
