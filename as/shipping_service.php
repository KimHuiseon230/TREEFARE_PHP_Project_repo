  ...
  <div class="container-fluid ">
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        <div class=" h-100">
          <div class="body">
            <h5 class="card-title mb-2">더 낮은 가격으로 만나는 TREEFARE 배송 서비스</h5>
            <p class="card-text">온/오프라인, 구매 금액에 상관없이 언제 어디서나 더 쉽고 편하게 이용할 수 있는 TREEFARE의 배송/픽업 서비스로 여러분의 홈퍼니싱 생활이 더욱 즐거워집니다.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row no-gutters">
        <div class="col-md-6">
          <div class="row m-auto h-100"> <!-- 요소 높이를 100%로 설정 -->
            <div class="col-md-12 bg-light py-4 mb-2">
              <h3>TREEFARE의 3단계 배송 & 픽업 서비스</h3>
              <p>가구 배송과 픽업 서비스, 택배 배송 요금의 구매 금액 조건이 없어지고 더욱 낮아졌어요.
                온/오프라인 구분없이, 필요에 따라쉽고 편하게 배송 옵션을 선택하여 이용해 보세요.</p>
              <p>
              <ul>
        ...
        <div class="col-md-6 bg-light py-4 h-100"> <!-- 요소 높이를 100%로 설정 -->
          <h5>오른쪽 영역</h5>
  ...
  <div class="container justify-content-around mt-5">
    <div class="row">
      <div class="card m-auto  " style="width: 23rem;">
        <img src="../images/main_ad_img1.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <p>\<strong class="card-text text-lg-center text-blue" id="card-text">3,000~</strong>
          </p>
        </div>
      </div>
      <div class="card m-auto  " style="width: 23rem;">
        <img src="../images/main_ad_img2.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <p>\<strong class="card-text text-lg-center text-blue" id="card-text">9,000~</strong>
        </div>
      </div>
      <div class="card m-auto  " style="width: 23rem;">
        <img src="../images/main_ad_img3.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <p>\<strong class="card-text text-lg-center text-blue" id="card-text">29,000~</strong>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container justify-content-around mt-5">
    <div class="row">
      <div class="card m-auto  " style="width: 24rem;">
        <img src="../images/main_ad_img5.png" class="card-img-top" alt="...">
        <div class="card-body">
          <p>
          <ul>
      ...
      <div class="card m-auto  " style="width: 24rem;">
        <img src="../images/main_ad_img6.png" class="card-img-top" alt="...">
        <div class="card-body">
          <p>
          <ul>
      ...
      <div class="card m-auto  " style="width: 24rem;">
        <img src="../images/main_ad_img7.png" class="card-img-top" alt="...">
        <div class="card-body">
          <p>
