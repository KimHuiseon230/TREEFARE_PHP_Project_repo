    ...
    <div class="col-sm-3 text-center" style="width: 16rem;">
      <div class="card justify-content-center">
        <div class="card-body   bg-light text-dark text-center" style="height: 300px;">
          ...
          <a href="http://<?= $_SERVER['HTTP_HOST'] . '/TREEFARE_PHP_Project/as/shipping_service.php' ?>" class="btn btn-secondary text-white ">배송 서비스</a>
        </div>
      </div>
    </div>
    <div class="col-sm-3 text-center" style="width: 16rem;">
      <div class="card justify-content-center">
        <div class="card-body   bg-light text-dark " style="height: 300px;">
          ...
          <a href="http://<?= $_SERVER['HTTP_HOST'] . '/TREEFARE_PHP_Project/as/click_pickup_service.php' ?>" class="btn btn-secondary text-white ">클릭 앤 픽업 서비스</a>
        </div>
      </div>
    </div>
    <div class="col-sm-3 text-center" style="width: 16rem;">
      <div class="card justify-content-center">
        <div class="card-body   bg-light text-dark" style="height: 300px;">
          ...
          <a href="http://<?= $_SERVER['HTTP_HOST'] . '/TREEFARE_PHP_Project/as/assembly_service.php' ?>" class="btn btn-secondary text-white">조립 서비스</a>
        </div>
      </div>
    </div>
    <div class="col-sm-3 text-center" style="width: 16rem;">
      <div class="card justify-content-center">
        <div class="card-body   bg-light text-dark" style="height: 300px;">
          ...
          <a href="http://<?= $_SERVER['HTTP_HOST'] . '/TREEFARE_PHP_Project/as/installation_service.php' ?>" class="btn btn-secondary text-white">설치 서비스</a>
        </div>
      </div>
    </div>
    <div class="col-sm-3 text-center" style="width: 16rem;">
      <div class="card justify-content-center">
        <div class="card-body   bg-light text-dark" style="height: 300px;">
          ...
          <a href="http://<?= $_SERVER['HTTP_HOST'] . '/TREEFARE_PHP_Project/as/kitchen_service.php' ?>" class="btn btn-secondary text-white">주방 서비스</a>
        </div>
      </div>
    </div>
  </div>
