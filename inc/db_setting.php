...
include_once $_SERVER['DOCUMENT_ROOT'] . "/TREEFARE_PHP_Project/inc/create_table.php";
include_once $_SERVER['DOCUMENT_ROOT'] . "/TREEFARE_PHP_Project/inc/create_table_data.php";
