...
$title = "treefare";
$menu_code = "mian";
include_once $_SERVER['DOCUMENT_ROOT'] . "/TREEFARE_PHP_Project/inc/db_setting.php";
//헤더부분 시작
if ($ses_level == 10) {
...
<div>
  <?php
  include_once $_SERVER['DOCUMENT_ROOT'] . "/TREEFARE_PHP_Project/inc/main_as.php";
  include_once $_SERVER['DOCUMENT_ROOT'] . "/TREEFARE_PHP_Project/inc/main_slide.php";
  include_once $_SERVER['DOCUMENT_ROOT'] . "/TREEFARE_PHP_Project/inc/main_slide2.php";
  ?>
  <!-- 메인부분 종료 -->
  <!-- 푸터부분 시작 -->
  <?php
